...
class Settings(object):  # pylint: disable=too-few-public-methods
    ...
    travis_autosave_final_commit = "[Results] Test of hpHosts---Ad-and-Tracking_web_hosts-file.net"
    # Default travis commit message
    travis_autosave_commit = "[Autosave] Test of hpHosts---Ad-and-Tracking_web_hosts-file.net"
    ...
    # Current directory.
    current_dir = '/home/travis/build/dead-hosts/hpHosts---Ad-and-Tracking_web_hosts-file.net/'
